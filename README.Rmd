...
Paquete para **descargar, limpiar y estructurar datos de La Quiniela** de forma reproducible.
Incluye funciones para obtener temporadas históricas, jornadas de la temporada actual
y el pronóstico de la jornada en curso.
...
Descarga una temporada histórica completa desde la jornada 1 hasta `max_jornada`.
